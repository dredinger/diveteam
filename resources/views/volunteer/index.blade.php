...
@section ('content')
	...
	<dl class="row">
		<dt class="col-sm-3">What Is The Deep Blue Sea Foundation Anyway?</dt>
		...
		<dt class="col-sm-3">Who Is The Deep Blue Sea Foundation?</dt>
		...
		<dd class="col-sm-9 offset-sm-3">The Aquarium has paid staff members in several departments including Aquarists, Trainers, Life Support, Education, Guest Services, Security, Sales, Housekeeping, and in the restaurant and lounge.</dd>
		<dd class="col-sm-9 offset-sm-3">The Aquarium has been owned by Landry's Restaurants, Inc. since March of 2003. Landry's owns many restaurants nationwide including local restaurants such as Saltgrass Steak House, Simms Steakhous, Oceanaire, and Chart House. Landry's also owns a Downtown Aquarium that opened in Houston in 2003. Previously operated as a private non-profit aquarium known as Ocean Journey, the Downtown Aquarium Denver is now part of a larger for-profit restaurant/entertainment company.</dd>

		<dt class="col-sm-3">What Do The Volunteers Do?</dt>
		<dd class="col-sm-9">Volunteer Aquarium Guides ARE the educational link between guests and our exhibits.</dd>
		...
		<dt class="col-sm-3">How Are The Volunteers Trained?</dt>
		<dd class="col-sm-9">Most of the training is on-the-job.</dd>
		...
		<dt class="col-sm-3">What's In It For Me?</dt>
		<dd class="col-sm-9">Other than being a fun place to learn fascinating things about the animal collection, the Deep Blue Sea Foundation provides additional benefits to the volunteers.</dd>
		...
		<dt class="col-sm-3">Uniforms</dt>
		<dd class="col-sm-9">Aquarium Guides wear a white polo shirt (provided for you at orientation) with the Deep Blue Sea Foundation logo.</dd>
		...
		<dt class="col-sm-3">Getting Signed Up</dt>
		<dd class="col-sm-9">Once you have decided on a position, call on of our Volunteer Coordinators at <a href="tel:3035614474">{{ phoneToReadable('3035614474') }}</a> or <a href="tel:3035614413">{{ phoneToReadable('3035614413') }}</a> to set up an interview. All volunteers are interviewed and background checked before starting. A drug test is also required. Keep in mind, some positions have a waitlist and you may not be able to start that position right away. Call immediately to make an appointment for an interview.</dd>
		...
		<dt class="col-sm-3">More Information</dt>
		<dd class="col-sm-9"><a href="{{ route('volunteer.assistant') }}">Animal Care Assistant</a></dd>
