...
@section ('content')
	...
	<div class="card card-inverse card-primary lead text-uppercase text-center font-weight-bold">
		<div class="card-block">If you would like to apply for this position, please click here to be redirected to our contact form.</div>
	</div>
	...
	<dl class="row">
		...
		<dt class="col-sm-3">Volunteer Training</dt>
